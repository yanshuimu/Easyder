...
- (void)viewDidLoad {
    ...
    _webView.frame = CGRectMake(0, 0, SCREEN_W, SCREEN_H - kNavBar_H - kViewBottom_H);
    ...
    if (!kStringIsEmpty(_htmlString))
    {
        [self loadHtmlContent];
    }
    else if (!kStringIsEmpty(_url))
    {
        NSURLRequest *request = [NSURLRequest requestWithURL:kUrlWithString(_url)];
